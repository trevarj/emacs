...
(declare-function wlshm-frame-geometry "wlshmfns.c" (&optional frame))
...
(declare-function wlshm-frame-edges "wlshmfns.c" (&optional frame type))
...
(declare-function wlshm-frame-restack "wlshmfns.c" (frame1 frame2 &optional above))
  ...
  (if (and (frame-live-p frame1)
      ...
      (let ((frame-type (framep-on-display frame1)))
        (cond
         ...
         ((eq frame-type 'wlshm)
          (wlshm-frame-restack frame1 frame2 above))
         ((eq frame-type 'android)
